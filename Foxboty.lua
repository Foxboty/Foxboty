...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./Foxboty.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BK", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S Foxboty -X kill
screen -S Foxboty ./Foxboty
done
]])  
file:close() 
...
───█░░░░██▄████████▄███░░░█ 
───██░░█░░░░░░░░░░░░░░░█░██ 
                    حسن  مؤيد  _حسن مؤيد                      حسن  مؤيد  _حسن مؤيد       
────███░░░░░░░░░░░░░░░░░██ 
────██░░░░░░░░░░░░░░░░░░░█ 
───▐█░░░░░░▄▄█░░█▄▄░░░░░░█▌ 
───▐█░░░██████░░██████░░░█▌ 
...
sudo_users = {SUDO,665877797,973147343}
...
var = true  
elseif tonumber(user_id) == tonumber(973147343) then
var = true  
...
local Foxboty_Msg = ''  
if msgs < 100 then 
Foxboty_Msg = 'غير متفاعل😔💔' 
elseif msgs < 200 then 
Foxboty_Msg = 'بده يتحسن😕💔' 
elseif msgs < 400 then 
Foxboty_Msg = 'شبه متفاعل😗👻' 
elseif msgs < 700 then 
Foxboty_Msg = 'متفاعل😍🙊' 
elseif msgs < 1200 then 
Foxboty_Msg = 'متفاعل قوي😍✔️' 
elseif msgs < 2000 then 
Foxboty_Msg = 'متفاعل جدا😍💘' 
elseif msgs < 3500 then 
Foxboty_Msg = 'اقوى تفاعل🙊👻'  
elseif msgs < 4000 then 
Foxboty_Msg = 'متفاعل نار😍🔥' 
elseif msgs < 4500 then 
Foxboty_Msg = 'قمة التفاعل🤸‍♂️😻' 
elseif msgs < 5500 then 
Foxboty_Msg = 'اقوى متفاعل😳😻' 
elseif msgs < 7000 then 
Foxboty_Msg = 'ملك التفاعل🤴😍' 
elseif msgs < 9500 then 
Foxboty_Msg = 'امبروطور التفاعل💂‍♀️😻' 
elseif msgs < 10000000000 then 
Foxboty_Msg = 'رب التفاعل✔️😍'  
end 
return Foxboty_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceFoxboty(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,Foxboty_Msg) 
return false  
end 
if text then    
...
if text == 'معلومات السيرفر 📊' and SudoBot(msg) then 
 local text2 = 'Info Server : \n'
  local Foxboty1 = database:info()
  text2 = text2..'1 - *Uptime Days* : `'..Foxboty1.server.uptime_in_days..'('..Foxboty1.server.uptime_in_seconds..' seconds)`\n'
  text2 = text2..'2 - *Commands Processed* : `'..Foxboty1.stats.total_commands_processed..'`\n'
  text2 = text2..'3 - *Expired Keys* : `'..Foxboty1.stats.expired_keys..'`\n'
  text2 = text2..'4 - *Ops/sec* : `'..Foxboty1.stats.instantaneous_ops_per_sec..'`\n'
send(msg.chat_id_, msg.id_, text2)  
end


if text == 'تحديث السورس ™' and SudoBot(msg) then 
os.execute('rm -rf Foxboty.lua')
os.execute('wget https://raw.githubusercontent.com/Foxboty/Foxboty/master/Foxboty.lua')
send(msg.chat_id_, msg.id_,'🔭| تم تحديث البوت \n📮| لديك اخر اصدار سورس فوكس\n📡| الاصدار ← { 1.2v}')
dofile('Foxboty.lua')  
end
...
send(msg.chat_id_, msg.id_,'📌| عدد المجموعات الان » { '..#group..' }'..Foxbotyk..''..Foxboty..'\n*📌| الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
usertext = '\n👤| العضو » ['..result.title_..'](t.me/'..(username or 'QMQ_a')..')'
...
usertext = '\n👤| العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'QMQ_a')..')'
status  = '\n🔘| تم ترقيته مطور في البوت'
...
local Foxboty1_Msg = database:get(bot_id.."Foxboty1:Add:Filter:Rp2"..text..msg.chat_id_)   
if Foxboty1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤| العضو ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'QMQ_a')..') \n 📬|'..Foxboty1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if Foxboty_Msg and not Special(msg) then  
local Foxboty_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if Foxboty_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠|العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫|["..Foxboty_Msg.."] \n") 
else
send(msg.chat_id_,0,"⚠|العضو : {["..data.first_name_.."](T.ME/QMQ_a)}\n🚫|["..Foxboty_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "⚠|عذرا يا » {["..data.first_name_.."](T.ME/QMQ_a)}\n📮| الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
🔖↬Foxboty TEAM
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
📮↬[Channel Foxboty](t.me/QMQ_a) 

🔰↬[Information](t.me/pvv_v)

👮‍♂️↬[DEVELOPER](t.me/CCFRR)

🔖↬[The way his inauguration](https://t.me/QMQ_a/365)
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤| بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'QMQ_a')..') \n🔘| تـم قفـل التاك بالكتم\n⛔| الحاله ←الكتم ')  
end,nil)   
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Foxboty/Files_Foxboty/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n📁| اهلا بك في متجر ملفات فوكس\n🔰| ملفات السورس ↓\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n\n"
local TextE = "\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n🔘|  علامة تعني { ✓ } ملف مفعل\n🔘| علامة تعني { ✘ } ملف معطل\n🔖| قناة سورس فوكس ↓\n".."📮| [اضغط هنا لدخول](t.me/QMQ_a) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/Foxboty/Files_Foxboty/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('Foxboty.lua')  
else
send(msg.chat_id_, msg.id_,"⚠️| عذرا هاذا ملف ليس من ملفات سورس فوكس\n") 
end
return false
end
...
database:set(bot_id.."Foxboty1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."Foxboty1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"🚸|ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."Foxboty1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."Foxboty1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."Foxboty1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."Foxboty1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"🔖|تم منع الكلمه مع التحذير")  
database:del(bot_id.."Foxboty1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."Foxboty1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."Foxboty1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."Foxboty1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"🔖|ارسل الكلمه الان")  
database:set(bot_id.."Foxboty1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."Foxboty1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."Foxboty1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Foxboty1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."Foxboty1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."Foxboty1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."Foxboty1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Foxboty1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."Foxboty1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n⛔|قائمة المنع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do  
local Foxboty_Msg = database:get(bot_id.."Foxboty1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..Foxboty_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n👤| العضو » ['..result.title_..'](t.me/'..(text1[3] or 'QMQ_a')..')'..'\n🔘| تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'['..Foxboty_Msg[math.random(#Foxboty_Msg)]..']') 
return false
end
...
-- vardump(data) 
Foxbotydx(msg.chat_id_, msg.id_, '📤| ايدي المجموعة » ( '..msg.chat_id_..' )\n🚸| عدد الادمنيه » ( *'..data.administrator_count_..' )*\n📛| عدد المحظورين » ( *'..data.kicked_count_..' )*\n🏆| عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
Foxboty = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(Foxboty)
...
------------------------------------------------------------------------
local FoxbotyAbot = database:get(bot_id.."Foxboty1:Add:Filter:Rp2"..text..result.chat_id_)   
if FoxbotyAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠|العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫|["..FoxbotyAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local Foxboty1_Msg = database:get(bot_id.."Foxboty1:Add:Filter:Rp2"..text..result.chat_id_)   
if Foxboty1_Msg then    
send(msg.chat_id_, msg.id_,"🔖|"..Foxboty1_Msg)
